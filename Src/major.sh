...
note7=$9
note8=${10}
cat > ${title}_Major_Scale_LO.ly << EOF
%\version "2.19.82"
...
cat > ${title}_Major_Scale_HO.ly << EOF
%\version "2.19.82"
...
note7=$9
note8=${10}
cat > ${title}_Major_Pentatonic_Scale_LO.ly << EOF
%\version "2.19.82"
...
\markup{"$title Major Pentatonic Scale"}
\score {{
    \global
    \relative c' {
...
cat > ${title}_Major_Pentatonic_Scale_HO.ly << EOF
%\version "2.19.82"
...
note7=$9
note8=${10}
cat > ${title}_Major_Arpeggios_LO.ly << EOF
%\version "2.19.82"
...
cat > ${title}_Major_Arpeggios_HO.ly << EOF
%\version "2.19.82"
...
note7=$9
note8=${10}
cat > ${title}_Major_Broken_Chords.ly << EOF
%\version "2.19.82"
...
note7=$9
note8=${10}
cat > ${title}_Major_Broken_3rd.ly << EOF
%\version "2.19.82"
...
note7=$9
note8=${10}
cat > ${title}_Major_Sequences.ly << EOF
%\version "2.19.82"
...
note7=$9
note8=${10}
cat > ${title}_Major_all_keys.ly << EOF
%\version "2.19.82"
...
note7=$9
note8=${10}
cat > ${title}_Major_Scale_2O.ly << EOF
%\version "2.19.82"
